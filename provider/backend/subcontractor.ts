...
export interface SubcontractorNode {
    id: string;
    type: 'smartphone' | 'iot' | 'laptop';
    status: 'idle' | 'busy' | 'offline';
    lastSeen: number;
}

export class SubcontractorManager {
    private subnodes: Map<string, SubcontractorNode> = new Map();
